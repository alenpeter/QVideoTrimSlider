//
//  QVideoTrimSliderThumbnailsManager.swift
//  QVideoEditor
//
...
class QVideoTrimSliderThumbnailsManager: NSObject {
    ...
    func updateThumbnails(view: UIView, videoURL: URL, duration: Float64) -> [UIImageView]{
        ...
        for i in 0..<imagesCount{
            let thumbnail = QVideoTrimSliderVideoHelper.thumbnailFromVideo(videoUrl: videoURL,
